    					...
    					<div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
									...
									$resultat=mysqli_query($connect,$requete) or die (mysqli_error($connect));
									if($resultat)
									...
									echo "<br><br>";
									echo "<form>";
									echo "<input type='button' class='btn' value=\"Retour\" onclick=\"window.location='liste_contrat.php';\">";
									echo "</form>";
