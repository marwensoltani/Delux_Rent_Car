...
<head>
	...
	<title>System de Location des Voitures - Modification reservation</title>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			<?php
				...
				//requête de travail
				$requete = "select objectifmission, kmparcourumission, qtecarburantmission, datereservation, datefinreservation
				from mission m, individu i, vehicule v
				where m.idindividu=i.idindividu and v.idvehicule=m.idvehicule and idmission='".$reservation."'";
    					...
    					<div class="col-md-12">
                            <div class="card">
                                <div class="card-header text-center" data-background-color="purple">
                                    <h4 class="title">Modification reservation</h4>
                                    <p class="categorie"><?php echo "Modification du Mission N° ".$reservation; ?></p>
                                </div>
                                <div class="card-content">
								<form action="modifier_reservation.php" method="POST">

								<input type="hidden" name="code" value="<?php echo $reservation?>">
								<table class="table">
									<tr>
										<td>
									...
									<tr>
										...
										<td>
											<input type="text" name="objectif" value="<?php echo $row[0]?>">
										</td>
									</tr>
									<tr><td height="8"></td></tr>
									<tr>
										...
										<td>
											<input type="text" name="km" value="<?php echo $row[1]?>">
										</td>
									</tr>
									<tr><td height="8"></td></tr>
									<tr>
										...
										<td>
											<input type="text" name="qte" value="<?php echo $row[2]?>">
										</td>
									</tr>
									<tr><td height="8"></td></tr>
									<tr>
									...
									<div align="right">
										<input type="button" class="btn btn-info" value="Retour" onClick="window.location='liste_reservation.php';">
